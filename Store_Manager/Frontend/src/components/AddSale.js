...
export default function AddSale({
  ...
  const addSale = () => {
    if (!sale.productID || !sale.storeID || !sale.stockSold || !sale.saleDate || !sale.totalSaleAmount) {
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <Dialog.Title className="text-lg py-4 font-semibold leading-6 text-gray-900">
                        Add Sale
                      </Dialog.Title>
                      <form>
                        <div className="grid gap-4 mb-4 sm:grid-cols-2">
                          ...
                          <div>
                            <label htmlFor="saleDate" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                              Sales Date
                            </label>
                            <input
                              type="date"
